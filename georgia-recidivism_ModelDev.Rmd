...
cvFit <- train(recidivism_within_3years ~ .,
                  data=Recidivism %>% 
                  dplyr::select(recidivism_within_3years, Recidivism_numeric,jobs_per_year,percent_days_employed, supervision_risk_score_first, prison_years, gang_affiliated, prior_arrest_episodes_felony, prior_arrest_episodes_misd,prior_arrest_episodes_violent, prior_arrest_episodes_property, prior_arrest_episodes_drug, avg_days_per_drugtest,drugtests_thc_positive,drugtests_cocaine_positive,drugtests_meth_positive,drugtests_other_positive,gender,race, age_at_release, residence_puma,education_level, dependents, prison_offense), 
